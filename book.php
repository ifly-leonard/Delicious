	...
	<div class="container">
		...
		<div class="row msg-row">
			...
			<div class="col-md-8 col-sm-8">
				<form action="booktable.php" method="GET" role="form">
					<div id="sendmessage">Your booking request has been sent. Thank you!</div>
					<div id="errormessage"></div>
					<div class="col-md-6 col-sm-6 contact-form pad-form">
						<div class="form-group label-floating is-empty">
							<input type="text" name="name" class="form-control" id="name"  value="<?php echo $_SESSION['username'] ?>" data-rule="minlen:4" data-msg="Please enter at least 4 chars" />
					...
					<div class="col-md-12 btnpad">
						<div class="contacts-btn-pad">
							<button class="contacts-btn" type="submit">Book Table</button>
						</div>
					</div>
				</form>
			</div>
